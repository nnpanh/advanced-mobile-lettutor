...
void onPressedCreateReview(Size size, BuildContext context, ReviewModel reviewModel, String lessonDate) {
  showDialog(
      context: context,
      builder: (BuildContext context) {
        return WidgetDialog(
            title: 'Create review', widget: CreateReviewDialogContent(size: size, reviewModel: reviewModel, lessonDate: lessonDate,));
      });
}
class CreateReviewDialogContent extends StatelessWidget {
  const CreateReviewDialogContent({super.key, required this.size, required this.reviewModel, required this.lessonDate});
  final Size size;
        ...
        children: [
          Container(
            ...
            child: RichText(text: TextSpan(
                ...
                children: [
                  TextSpan(text: "Rate "),
                  TextSpan(text:"${reviewModel.userName} ",style: bodyLargeBold(context)?.copyWith(
                      fontSize: 16
                  )),
