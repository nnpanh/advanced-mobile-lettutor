...
class _SearchResultPageState extends State<SearchResultPage> {
  ...
  void initState() {
    ...
    switch (widget.nationality) {
      case Nationality.nationForeign:
        nationalityInput = {"isVietNamese": false, "isNative": false};
        break;
      case Nationality.nationAll:
        nationalityInput = {};
        break;
      case Nationality.nationVN:
        nationalityInput = {"isVietNamese": true, "isNative": false};
        break;
      case Nationality.nationNative:
        nationalityInput = {"isNative": true};
        break;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: appBarDefault(MyRouter.searchResults, context),
            ...
            Container(
                ...
                child: Pagination(
                  ...
                  onPageChange: (number) {
                    ...
                    //Call API
                    callAPISearchTutor(number, TutorRepository(), authProvider);
                  },
                  useGroup: false,
