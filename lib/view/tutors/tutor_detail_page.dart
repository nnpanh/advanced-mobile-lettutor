...
class _TutorDetailPageState extends State<TutorDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        authProvider.refreshHome = _hasChangedFavor;
        return true;
      },
      child: Scaffold(
          appBar: appBarDefault(
              AppLocalizations.of(context)!.tutorDetails, context),
          body: !_hasFetch
              ? const LoadingFilled()
