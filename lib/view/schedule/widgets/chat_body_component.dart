...
import 'package:lettutor/view/schedule/widgets/receiver_card.dart';
import 'package:lettutor/view/schedule/widgets/sender_card.dart';
...
class _ChatBodyComponentState extends State<ChatBodyComponent> {
  ...
  Widget build(BuildContext context) {
    if (widget.chatHistory.isNotEmpty) {
      ...
      return Container(
          alignment: Alignment.center,
          child: Text("Start your first prompt",  style: bodyLarge(context),));
    }
  }
}